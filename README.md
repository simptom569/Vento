...
Vento — защищённый мессенджер уровня Телеграма. FastAPI бэкенд с Clean Architecture, E2E шифрованием, поддержкой сообщений, голосовых/видео звонков, каналов и ленты постов.
